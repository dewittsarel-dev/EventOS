...
describe('EventsService', () => {
  ...
  it('creates an event when access and contact ownership are valid', async () => {
    prisma.event.create.mockResolvedValue({ id: eventId });
    ...
    const result = await service.create(userId, {
      ...
      startDateTime: '2026-12-01T12:00:00.000Z',
      endDateTime: '2026-12-01T14:00:00.000Z',
      location: 'Venue 1',
  ...
  it('lists paginated events with filters', async () => {
    ...
    prisma.event.findMany.mockResolvedValue([{ id: eventId }]);
