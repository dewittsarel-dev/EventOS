...
describe('dashboard-utils', () => {
  ...
  it('builds sections with upcoming events, urgent tasks, and sorted recent records', () => {
    const sections = buildDashboardSections({
      ...
      tasks: [
        task({ id: 't-1', dueDate: '2026-07-29T09:00:00.000Z', priority: 'Medium', status: 'Todo' }),
        task({ id: 't-2', dueDate: '2026-08-02T09:00:00.000Z', priority: 'Critical', status: 'InProgress' }),
