        ...
        <div className="mt-7 rounded-3xl border border-stone-200 bg-white p-4 shadow-sm md:p-6">
          ...
          {mode === 'guided' ? (
            <div className="mt-5 grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
              ...
              <label className="text-xs font-semibold text-stone-600">Theme<input value={guidedTheme} onChange={(event) => setGuidedTheme(event.target.value)} placeholder="Garden, heritage, awards..." className="mt-1 block w-full rounded-xl border border-stone-200 px-3 py-2.5 text-sm font-normal text-stone-950" /></label>
              ...
              <div className="rounded-2xl bg-stone-50 p-4 text-sm text-stone-600 sm:col-span-2 lg:col-span-4">
                ...
                {guidedEventSearchTerms(guidedType, guidedStyle, [guidedColour], guidedTheme).join(', ')}
              </div>
