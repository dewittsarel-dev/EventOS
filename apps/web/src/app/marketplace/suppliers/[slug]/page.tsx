...
export default function MarketplaceSupplierPage() {
  ...
  return <main className="min-h-screen bg-[#f5f1e9] text-stone-950">
    <header className="border-b border-stone-200 bg-[#fffdf9] px-5 py-4 md:px-10"><div className="mx-auto flex max-w-7xl items-center justify-between gap-3"><a href="/marketplace" className="font-semibold tracking-tight">← EventOS Marketplace</a><a href="/login" className="rounded-full border border-stone-300 bg-white px-4 py-2 text-sm">ClientOS sign in</a></div></header>
