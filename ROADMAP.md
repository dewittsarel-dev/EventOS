...
- Simulation and launch assurance — IN PROGRESS: the deterministic 150-business baseline now covers suppliers, planners, venues and specialist providers with explicit synthetic labelling, licensed/generated image policy and repeatable regression rules. Isolated persistence seeding, scenario drivers, failure injection, performance, restore and upgrade rehearsals remain controlled follow-up slices.
